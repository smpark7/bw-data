...
[Mesh]
  # file = 'msfr-1-16-core-full-bl.e'
  file = 'msfr-ins_exodus.e'
[../]
...
[Materials]
  ...
  [./struc]
    ...
    block = 'bottom_ref_HEX8 bottom_ref_WEDGE outer_ref top_ref_HEX8 top_ref_WEDGE'
  [../]
  [./hx]
    type = GenericMoltresMaterial
...
[Functions]
  [./xvelFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((z - 100) / 18.75 - ((z - 100) / 18.75)^2) * (1 - exp(-t)) * (x / 112.75)'
    # value = '-508.5025 * 4 * (z / 18.75 - (z / 18.75)^2) * (1) * (x / 112.75)'
  [../]
  [./yvelFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((z - 100) / 18.75 - ((z - 100) / 18.75)^2) * (1 - exp(-t)) * (y / 112.75)'
    # value = '-508.5025 * 4 * (z / 18.75 - (z / 18.75)^2) * (1) * (y / 112.75)'
  [../]
[]
...
[BCs]
  ...
  [./ux_dirichlet]
    type = DirichletBC
    boundary = 'core_outer core_bottom core_top axial2' # axial
    variable = ux
    value = 0
  [../]
  [./uy_dirichlet]
