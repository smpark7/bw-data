...
[Materials]
  ...
  [./core_k]
    ...
    function = '731.76 * (0.75 + 0.25 * exp(-time/8)) + .01'
    block = 'core outlet'
  [../]
  [./core_mu]
    type = ParsedMaterial
    f_name = mu
    material_property_names = 'time'
    function = '4e-1 * (0.75 + 0.25*exp(-time/8)) + .001e-1'
    block = 'core outlet'
  [../]
  [./blanket]
    type = GenericMoltresMaterial
...
[Functions]
  [./velFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((y - 100) / 18.75 - ((y - 100) / 18.75)^2) * (0.057471 + 0.942529 * exp(-t/8))'
  [../]
[]
