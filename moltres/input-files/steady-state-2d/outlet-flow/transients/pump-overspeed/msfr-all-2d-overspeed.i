...
[Materials]
  ...
  [./core_k]
    ...
    function = '731.77 * (1 + .5 * (1 - exp(-time/5)))'
    block = 'core outlet'
  [../]
  [./core_mu]
    type = ParsedMaterial
    f_name = mu
    material_property_names = 'time'
    function = '4e-1 * (1 + .5 * (1 - exp(-time/5))) + .001e-1'
    block = 'core outlet'
  [../]
  [./blanket]
    type = GenericMoltresMaterial
...
[Functions]
  [./velFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((y - 100) / 18.75 - ((y - 100) / 18.75)^2) * (1 + .5 * (1 - exp(-t/5)))'
  [../]
[]
