...
[Functions]
  [./xvelFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((z - 100) / 18.75 - ((z - 100) / 18.75)^2) * (1 - exp(-t/5)) * (x / 112.75)'
    # value = '-508.5025 * 4 * (z / 18.75 - (z / 18.75)^2) * (1) * (x / 112.75)'
  [../]
  [./yvelFunc]
    type = ParsedFunction
    value = '-508.5025 * 4 * ((z - 100) / 18.75 - ((z - 100) / 18.75)^2) * (1 - exp(-t/5)) * (y / 112.75)'
